...
public class DetalleCompra implements Serializable {
    ...
    private double detalle_valorTc, detalle_valorU;
    ...
    public DetalleCompra(int com_id, int qui_id, int detalle_cantidad, double detalle_valorTC, double detalle_valorU) {
        this.com_id = com_id;
        this.inv_id = qui_id;
        this.detalle_cantidad = detalle_cantidad;
        this.detalle_valorTc = detalle_valorTC;
    ...
    public String toString() {
        return "DetalleCompra{" + "com_id=" + com_id + ", qui_id=" + inv_id + ", detalle_cantidad=" + detalle_cantidad + ", detalle_valorTC=" + detalle_valorTc + ", detalle_valorU=" + detalle_valorU + '}';
    }
